...
![](/img/tsx006.png)
[Click here to enter the example library](/tesserxel/examples/#). If you see these lines of text, you should download the latest version of Google Chrome or ~~the Canary version of Google Chrome~~, see [here](/archives/tesserxel-hello/).
![](/img/tsx003.png)
