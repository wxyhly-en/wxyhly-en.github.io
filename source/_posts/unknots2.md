...
<table><tr><td>![瘪球的截线动画](/img/unknots202.gif)</td><td>![世界地图上的截线动画](/img/unknots201.gif)</td></tr></table>
...
### 解开球面结
根据上面三道题的经验，我们先直接尝试合并分支点。观察发现，下图中两边标有1与4的分支点可以碰面，而两边标有2与3的分支点也可以碰面，要记住这是球体的展开图，因此我们可以像跨过“国际日期变更线”那样去另一边。
![](/img/unknots215.svg)
