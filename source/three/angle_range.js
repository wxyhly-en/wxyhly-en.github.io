...
class Core {
    ...
    draw() {
        ...
        this.drawText("Coincidence", 0, 0, context);
        this.drawText("Opposite in Direction", 180, 0, context);
        this.drawText("Abs. Perpendicular (Self-Dual)", 90, 90, context);
        this.drawText("Abs. Perpendicular (Anti-Self-Dual)", 90, -90, context);
        this.drawText("Left Isoclinic", 45, 45, context);
        this.drawText("Left Isoclinic", 135, -45, context);
        this.drawText("Right Isoclinic", 45, -45, context);
        this.drawText("Right Isoclinic", 135, 45, context);
        context.lineWidth = 2;
